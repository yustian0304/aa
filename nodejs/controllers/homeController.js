...
exports.home = function(req, res) {
    // res.send('NOT IMPLEMENTED: Book list')
    res.render('layout',{
          'render_view' :{'model':'home','view':'home'},
        'result'      :'welcome',
      });
};

// Display detail page for a specific Author.
exports.book_login = function(req, res) {
    // res.send('NOT IMPLEMENTED: Author detail: ' + req.params.id);
    console.log(session.uniqueID);
    res.render('login');
};

exports.book_check_login = function(req, res) {
    // res.send('NOT IMPLEMENTED: Author detail: ');
    var username=req.body.username;
    var sql="select count(*) as total from user_details where email='"+username+"'";
...
exports.book_check_logout = function(req, res) {
    // res.send('NOT IMPLEMENTED: Author detail: ');
